...
<?php include 'header.php'; ?>
  <img src="epices.png" alt="Épices" width="100%">
  <div class="main-content">
    <aside class="sidebar">
      <h2>Épices</h2>
      <ul>
        <li><a href="#">Epices de base</a></li>
        <li><a href="#">Epices exotiques</a></li>
        <li><a href="#">Mélange d'épices</a></li>
      </ul>
    </aside>
      ...
      <div class="product-list">
        ...
        try {
          ...
          $sql = "SELECT NOM_PRODUIT as nom, PRIX as prix, photo FROM PRODUIT 
                  ...
                  WHERE CATEGORIE.NOM_CATEGORIE = 'epices'";
          $stmt = $Con->query($sql);
